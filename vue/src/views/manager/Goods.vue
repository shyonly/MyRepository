  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="typeId" label="商品分类" show-overflow-tooltip></el-table-column>
        <el-table-column prop="businessId" label="所属商家" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close :show-close="false">
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item lable="商品介绍" lable-width="15%">
    ...
    <el-dialog @close="cancel" title="商品介绍" :visible.sync="editorVisible" width="50%">
