      ...
      <div style="padding: 15px 20px">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            ...
            <div style="color: #666666FF; margin-top: 20px">商家：{{goodsData.businessId}}</div>
            <div style="color: #666666FF; margin-top: 20px">分类：<a href="#" @click="navTo('/front/type?id=' + goodsData.typeId)"> {{goodsData.typeId}}</a></div>
